...
export interface MeshcoreWasm {
  ...
  encodeDirectTextIdentity(seed: string, peerPubKey: string, text: string, timestamp: number, attempt: number): HexResult | ErrResult;
  encodeDirectTextIdentityPath(seed: string, peerPubKey: string, text: string, timestamp: number, attempt: number, path: string, pathHashSize: number): HexResult | ErrResult;
  encodeDirectTextExpanded(expandedPrivKey: string, myPubKey: string, peerPubKey: string, text: string, timestamp: number, attempt: number): HexResult | ErrResult;
  encodeDirectTextExpandedPath(expandedPrivKey: string, myPubKey: string, peerPubKey: string, text: string, timestamp: number, attempt: number, path: string, pathHashSize: number): HexResult | ErrResult;
  ...
  encodeTextAck(timestamp: number, attempt: number, text: string, senderPubKey: string): HexResult | ErrResult;
  encodePathTextAckIdentity(seed: string, peerPubKey: string, timestamp: number, attempt: number, text: string, path: string, pathHashSize: number): HexResult | ErrResult;
  encodePathTextAckExpanded(expandedPrivKey: string, myPubKey: string, peerPubKey: string, timestamp: number, attempt: number, text: string, path: string, pathHashSize: number): HexResult | ErrResult;
  ...
  computeContentHash(packet: string): ContentHashResult | ErrResult;
  ...
  decodePathExpanded(payload: string, expandedPrivKey: string, peerPubKey: string): ReturnedPathPayload | ErrResult;
...
export const meshcoreOpNames = [
  ...
  "encodeGrpDataSecret",
  "encodeDirectText",
  "encodeDirectTextIdentity",
  "encodeDirectTextIdentityPath",
  "encodeDirectTextExpanded",
  "encodeDirectTextExpandedPath",
  "encodeAdvert",
  "encodeAck",
  "encodeTextAck",
  "encodePathTextAckIdentity",
  "encodePathTextAckExpanded",
  "encodeReq",
  "encodeAnonReq",
  "encodeDiscoverReq",
  "encodeTrace",
...
export const OpMetas: OpMeta[] = [
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        name: "peerPubKey",
        kind: "hex",
        label: "Peer public key (32 bytes)",
        placeholder: "64 hex chars",
        optional: false,
        choices: [],
        showWhen: "",
  ...
  },
  {
    ...
    params: [
      {
        name: "expandedPrivKey",
        kind: "hex",
        label: "My expanded private key (64 bytes)",
    ...
    params: [
      {
        name: "timestamp",
        kind: "int",
        label: "Message timestamp (epoch seconds)",
        placeholder: "0",
        optional: false,
        choices: [],
        showWhen: "",
  ...
  },
  {
    ...
    result: [
      { name: "hash", kind: "string", optional: false, label: "Content hash (16 hex)" },
    ],
  },
  {
    name: "decodeEnvelope",
  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        name: "privKey",
        kind: "string",
        label: "My private key (64 or 32 hex bytes)",
        placeholder: "128 hex chars (companion export)",
        optional: false,
        choices: [],
        showWhen: "",
        showValue: 0,
